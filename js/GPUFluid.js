...
var GPUFluid = function(width,height,cellSize,solverIterations) {
	...
	if(snow_modules_opengl_web_GL.current_context.getExtension("OES_texture_float_linear") == null) texture_float_linear_supported = false;
	if(snow_modules_opengl_web_GL.current_context.getExtension("OES_texture_float") == null) null;
...
shaderblox_ShaderBase.prototype = {
	...
	,compile: function(vertSource,fragSource) {
		...
		if(snow_modules_opengl_web_GL.current_context.getShaderParameter(vertexShader,35713) == 0) {
			haxe_Log.trace("Error compiling vertex shader: " + snow_modules_opengl_web_GL.current_context.getShaderInfoLog(vertexShader),{ fileName : "ShaderBase.hx", lineNumber : 74, className : "shaderblox.ShaderBase", methodName : "compile"});
		...
		if(snow_modules_opengl_web_GL.current_context.getShaderParameter(fragmentShader,35713) == 0) {
			haxe_Log.trace("Error compiling fragment shader: " + snow_modules_opengl_web_GL.current_context.getShaderInfoLog(fragmentShader) + "\n",{ fileName : "ShaderBase.hx", lineNumber : 84, className : "shaderblox.ShaderBase", methodName : "compile"});
...
var GPUParticles = function(count) {
	this.gl = snow_modules_opengl_web_GL;
	snow_modules_opengl_web_GL.current_context.getExtension("OES_texture_float");
	this.textureQuad = gltoolbox_GeometryTools.getCachedUnitQuad();
...
GPUParticles.prototype = {
	...
	,setCount: function(newCount) {
		...
		var arrayUVs;
		var elements = dataWidth * dataHeight * 2;
		var this1;
...
Main.prototype = $extend(snow_App.prototype,{
	...
	,render: function(w) {
		...
		snow_modules_opengl_web_GL.current_context.blendFunc(770,770);
	...
	,lowerQualityRequired: function(magnitude) {
		...
		haxe_Log.trace("Average FPS: " + this.performanceMonitor.fpsSample.average + ", lowering quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 319, className : "Main", methodName : "lowerQualityRequired"});
	...
	,higherQualityRequired: function(magnitude) {
		...
		var newQuality = Type.createEnumIndex(SimulationQuality,qualityIndex);
		haxe_Log.trace("Raising quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 339, className : "Main", methodName : "higherQualityRequired"});
		this.set_simulationQuality(newQuality);
		this.updateSimulationTextures();
	}
	,reset: function() {
...
gltoolbox_GeometryTools.getCachedClipSpaceQuad = function(drawMode) {
	...
	if(clipSpaceQuad == null || !snow_modules_opengl_web_GL.current_context.isBuffer(clipSpaceQuad)) {
...
gltoolbox_render_RenderTarget.prototype = {
	...
	,dispose: function() {
		snow_modules_opengl_web_GL.current_context.deleteFramebuffer(this.frameBufferObject);
		snow_modules_opengl_web_GL.current_context.deleteTexture(this.texture);
	}
...
gltoolbox_render_RenderTarget2Phase.prototype = {
	...
	,dispose: function() {
		snow_modules_opengl_web_GL.current_context.deleteFramebuffer(this.writeFrameBufferObject);
		snow_modules_opengl_web_GL.current_context.deleteFramebuffer(this.readFrameBufferObject);
		snow_modules_opengl_web_GL.current_context.deleteTexture(this.writeToTexture);
		snow_modules_opengl_web_GL.current_context.deleteTexture(this.readFromTexture);
	}
